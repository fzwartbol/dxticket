...
as org.example/dxticket:0.1.0-SNAPSHOT
...
As a result, default db credentials will be used (admin/admin) and DB name will be the same as project's artifactId (e.g. dxticket)
